...
// 	calc_TRISE = (RCC_GetBusPrescaler(RCC_APB1_BUS)/FREQ_1MHz);
...
// 	// Configure GPIOs
// 	GPIO_Init(I2C_CONFIGx->SCL.GPIO, I2C_CONFIGx->SCL.PIN, I2C_CONFIGx->SCL.MODE, I2C_CONFIGx->SCL.CNF);
// 	GPIO_Init(I2C_CONFIGx->SDA.GPIO, I2C_CONFIGx->SDA.PIN, I2C_CONFIGx->SDA.MODE, I2C_CONFIGx->SDA.CNF);
// 	// Software Reset
...
// 	// I2C Frequency
// 	I2C_CONFIGx->freq_MHz = (RCC_GetBusPrescaler(RCC_APB1_BUS)/FREQ_1MHz);
