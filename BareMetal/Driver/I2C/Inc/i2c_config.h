 ...
 */
__STATIC_INLINE__ void I2C_Clk_Enable(I2C_TypeDef* I2Cx){
	// Enable AFIO
 ...
 * @param[in] I2Cx I2C Instance: `I2C1`, `I2C2`
 */
__STATIC_INLINE__ void I2C_Clk_Disable(I2C_TypeDef* I2Cx){
	// Disable AFIO
	RCC->APB2ENR.REG &= ~RCC_APB2ENR_AFIOEN;
	// I2C1
	if(I2Cx == I2C1){
 ...
 * @param[in] I2Cx I2C Instance: `I2C1`, `I2C2`
 */
__STATIC_INLINE__ void I2C_Enable(I2C_TypeDef* I2Cx){
 ...
 * @param[in] I2Cx I2C Instance: `I2C1`, `I2C2`
 */
__STATIC_INLINE__ void I2C_Disable(I2C_TypeDef* I2Cx){
	// Enable the I2C Module
	I2Cx->CR1.REG &= ~I2C_CR1_PE;
}
