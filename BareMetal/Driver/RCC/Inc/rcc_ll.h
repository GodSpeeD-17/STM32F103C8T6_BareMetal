 ...
 * @file	rcc_ll.h
 * @author	Shrey Shah
 * @brief Declares register-near RCC access and raw field operations
 * @version	v5.0
 * @date	23-08-2026
 *
 * @details
 * @section RCC_LL_H_HIERARCHY Hierarchy
 * - Position: Layer 1 RCC hardware-access layer
 * - Used by: Layer 3 RCC Driver implementation
 * - Uses: Layer 0 Core RCC register model and shared RegOps mechanics
 *
 * @section RCC_LL_H_RESPONSIBILITY Responsibility
 * LL owns one shared pointer-based register read/write pair, symmetric named
 * full-register accessors, raw RCC field Get/Set pairs, oscillator operation,
 * and mechanical gate/reset mutations.
 *
 * @section RCC_LL_H_BOUNDARY Dependency Boundary
 * LL accepts raw fields and masks only. It owns no public selector vocabulary,
 * selector translation, clock-tree sequencing, timeout, derived-frequency
 * calculation, cache, or application policy.
 *
 ...
 */
#define LL_RCC_REG(_REG)		REGOPS_REG(((RCC_TypeDef*) RCC_BASE_ADDRESS), _REG)

/**
 * @brief Reads one RCC register image by register pointer
 * @param[in] pRegister Pointer to an RCC register image
 * Expected values:
 * - Non-`NULL`: Aligned pointer to one readable 32-bit RCC register image
 ...
 * Expected values:
 * - Non-`NULL`: Aligned pointer to one writable 32-bit RCC register image
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_CR` image
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_CFGR` image
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_AHBENR` image
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_APB2ENR` image
 * @note Caller owns read-modify-write staging for the requested clock-gate mask.
 */
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_APB1ENR` image
 * @note Caller owns read-modify-write staging for the requested clock-gate mask.
 */
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_APB2RSTR` image
 ...
 * Accepted values:
 * - `0x00000000UL..0xFFFFFFFFUL`: Complete caller-staged `RCC_APB1RSTR` image
 * @note Caller owns force/release reset-bit staging and pulse sequencing.
 */
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_SW` encodings
...
(							\
	((_FIELD) == RCC_CFGR_SW_HSI)	||	\
	((_FIELD) == RCC_CFGR_SW_HSE)	||	\
	((_FIELD) == RCC_CFGR_SW_PLL)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_PLLSRC` encodings
...
(							\
	((_FIELD) == RCC_CFGR_PLLSRC_HSI_DIV2)	||	\
	((_FIELD) == RCC_CFGR_PLLSRC_HSE)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_PLLXTPRE` encodings
...
(							\
	((_FIELD) == RCC_CFGR_PLLXTPRE_HSE)		||	\
	((_FIELD) == RCC_CFGR_PLLXTPRE_HSE_DIV2)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_PLLMUL` encodings
...
(							\
	((_FIELD) == RCC_CFGR_PLLMUL_2)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_3)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_4)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_5)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_6)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_7)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_8)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_9)		||	\
	((_FIELD) == RCC_CFGR_PLLMUL_10)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_11)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_12)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_13)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_14)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_15)	||	\
	((_FIELD) == RCC_CFGR_PLLMUL_16)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_HPRE` encodings
...
(							\
	((_FIELD) == RCC_CFGR_HPRE_DIV1)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV2)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV4)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV8)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV16)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV64)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV128)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV256)	||	\
	((_FIELD) == RCC_CFGR_HPRE_DIV512)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_PPRE1` encodings
...
(							\
	((_FIELD) == RCC_CFGR_PPRE1_DIV1)	||	\
	((_FIELD) == RCC_CFGR_PPRE1_DIV2)	||	\
	((_FIELD) == RCC_CFGR_PPRE1_DIV4)	||	\
	((_FIELD) == RCC_CFGR_PPRE1_DIV8)	||	\
	((_FIELD) == RCC_CFGR_PPRE1_DIV16)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_PPRE2` encodings
...
(							\
	((_FIELD) == RCC_CFGR_PPRE2_DIV1)	||	\
	((_FIELD) == RCC_CFGR_PPRE2_DIV2)	||	\
	((_FIELD) == RCC_CFGR_PPRE2_DIV4)	||	\
	((_FIELD) == RCC_CFGR_PPRE2_DIV8)	||	\
	((_FIELD) == RCC_CFGR_PPRE2_DIV16)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_ADCPRE` encodings
...
(							\
	((_FIELD) == RCC_CFGR_ADCPRE_DIV2)	||	\
	((_FIELD) == RCC_CFGR_ADCPRE_DIV4)	||	\
	((_FIELD) == RCC_CFGR_ADCPRE_DIV6)	||	\
	((_FIELD) == RCC_CFGR_ADCPRE_DIV8)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image to test against the supported `RCC_CFGR_USBPRE` encodings
...
(							\
	((_FIELD) == RCC_CFGR_USBPRE_DIV1_5)	||	\
	((_FIELD) == RCC_CFGR_USBPRE_DIRECT)		\
)
 ...
 * Accepted values:
 * - Any @ref reg image; zero is rejected and every non-zero mask is accepted
...
__STATIC_FORCEINLINE driver_status_t LL_RCC_GetHSIReadyStatus(void)
{
	...
	//! Map the single hardware-ready bit to the Driver's binary ready-state vocabulary.
	if ((crImage & RCC_CR_HSIRDY) != 0x00UL)
	{
...
__STATIC_FORCEINLINE driver_status_t LL_RCC_GetHSEReadyStatus(void)
{
	...
	//! Map the single hardware-ready bit to the Driver's binary ready-state vocabulary.
	if ((crImage & RCC_CR_HSERDY) != 0x00UL)
	{
		return DRIVER_STATUS_READY;
	}
	else
...
__STATIC_FORCEINLINE driver_status_t LL_RCC_GetPLLReadyStatus(void)
{
	...
	//! Map the single hardware-ready bit to the Driver's binary ready-state vocabulary.
	if ((crImage & RCC_CR_PLLRDY) != 0x00UL)
	{
		return DRIVER_STATUS_READY;
	}
	else
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_SW_HSI`: Selects HSI as SYSCLK
 * - @ref `RCC_CFGR_SW_HSE`: Selects HSE as SYSCLK
 * - @ref `RCC_CFGR_SW_PLL`: Selects PLL as SYSCLK
 ...
 * Expected values:
 * - @ref `RCC_CFGR_SWS_HSI`
 * - @ref `RCC_CFGR_SWS_HSE`
 * - @ref `RCC_CFGR_SWS_PLL`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_PLLSRC_HSI_DIV2`: Selects HSI/2 as the PLL input
 * - @ref `RCC_CFGR_PLLSRC_HSE`: Selects HSE as the PLL input
 ...
 * Expected values:
 * - @ref `RCC_CFGR_PLLSRC_HSI_DIV2`
 * - @ref `RCC_CFGR_PLLSRC_HSE`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_PLLXTPRE_HSE`: HSE feeds the PLL undivided
 * - @ref `RCC_CFGR_PLLXTPRE_HSE_DIV2`: HSE/2 feeds the PLL
 ...
 * Expected values:
 * - @ref `RCC_CFGR_PLLXTPRE_HSE`
 * - @ref `RCC_CFGR_PLLXTPRE_HSE_DIV2`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_PLLMUL_2`
 * - @ref `RCC_CFGR_PLLMUL_3`
 * - @ref `RCC_CFGR_PLLMUL_4`
 * - @ref `RCC_CFGR_PLLMUL_5`
 * - @ref `RCC_CFGR_PLLMUL_6`
 * - @ref `RCC_CFGR_PLLMUL_7`
 * - @ref `RCC_CFGR_PLLMUL_8`
 * - @ref `RCC_CFGR_PLLMUL_9`
 * - @ref `RCC_CFGR_PLLMUL_10`
 * - @ref `RCC_CFGR_PLLMUL_11`
 * - @ref `RCC_CFGR_PLLMUL_12`
 * - @ref `RCC_CFGR_PLLMUL_13`
 * - @ref `RCC_CFGR_PLLMUL_14`
 * - @ref `RCC_CFGR_PLLMUL_15`
 * - @ref `RCC_CFGR_PLLMUL_16`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_HPRE_DIV1`
 * - @ref `RCC_CFGR_HPRE_DIV2`
 * - @ref `RCC_CFGR_HPRE_DIV4`
 * - @ref `RCC_CFGR_HPRE_DIV8`
 * - @ref `RCC_CFGR_HPRE_DIV16`
 * - @ref `RCC_CFGR_HPRE_DIV64`
 * - @ref `RCC_CFGR_HPRE_DIV128`
 * - @ref `RCC_CFGR_HPRE_DIV256`
 * - @ref `RCC_CFGR_HPRE_DIV512`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_PPRE1_DIV1`
 * - @ref `RCC_CFGR_PPRE1_DIV2`
 * - @ref `RCC_CFGR_PPRE1_DIV4`
 * - @ref `RCC_CFGR_PPRE1_DIV8`
 * - @ref `RCC_CFGR_PPRE1_DIV16`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_PPRE2_DIV1`
 * - @ref `RCC_CFGR_PPRE2_DIV2`
 * - @ref `RCC_CFGR_PPRE2_DIV4`
 * - @ref `RCC_CFGR_PPRE2_DIV8`
 * - @ref `RCC_CFGR_PPRE2_DIV16`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_ADCPRE_DIV2`
 * - @ref `RCC_CFGR_ADCPRE_DIV4`
 * - @ref `RCC_CFGR_ADCPRE_DIV6`
 * - @ref `RCC_CFGR_ADCPRE_DIV8`
 ...
 * Accepted values:
 * - @ref `RCC_CFGR_USBPRE_DIV1_5`: USB clock equals PLL divided by 1.5
 * - @ref `RCC_CFGR_USBPRE_DIRECT`: USB clock equals PLL directly
 ...
 * Expected values:
 * - @ref `RCC_CFGR_USBPRE_DIV1_5`
 * - @ref `RCC_CFGR_USBPRE_DIRECT`
 ...
 * Accepted values:
 * - `1UL..0xFFFFFFFFUL`: Non-zero AHB clock-enable mask
 ...
 * Accepted values:
 * - `1UL..0xFFFFFFFFUL`: Non-zero APB2 clock-enable mask
 ...
 * Accepted values:
 * - `1UL..0xFFFFFFFFUL`: Non-zero APB1 clock-enable mask
 ...
 * Accepted values:
 * - `1UL..0xFFFFFFFFUL`: Non-zero APB2 reset mask
 ...
 * Accepted values:
 * - `1UL..0xFFFFFFFFUL`: Non-zero APB1 reset mask
