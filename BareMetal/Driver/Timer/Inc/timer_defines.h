...
#define TIM_INSTANCE_INDEX_FIRST						((timer_instance_index_t) 0x00U)
/** @brief `TIM2` instance index @def TIM_INSTANCE_INDEX_TIM2 */
#define TIM_INSTANCE_INDEX_TIM2							((timer_instance_index_t) 0x00U)
/** @brief `TIM3` instance index @def TIM_INSTANCE_INDEX_TIM3 */
#define TIM_INSTANCE_INDEX_TIM3							((timer_instance_index_t) 0x01U)
/** @brief `TIM4` instance index @def TIM_INSTANCE_INDEX_TIM4 */
#define TIM_INSTANCE_INDEX_TIM4							((timer_instance_index_t) 0x02U)
/** @brief `TIM5` instance index @def TIM_INSTANCE_INDEX_TIM5 */
#define TIM_INSTANCE_INDEX_TIM5							((timer_instance_index_t) 0x03U)
...
#define TIM_INSTANCE_COUNT								((timer_instance_index_t) (TIM_INSTANCE_INDEX_LAST + 1U))
 ...
 */
__STATIC_FORCEINLINE timer_instance_index_t TIM_InstanceToIndex(const TIM_TypeDef* const TIMx)
{
	// Local Variables
	timer_instance_index_t instanceIndex = TIM_INSTANCE_INDEX_INVALID;
...
#define TIM_CHANNEL_INDEX_FIRST						((timer_channel_index_t) 0U)
/** @brief Last valid zero-based Timer channel index @def TIM_CHANNEL_INDEX_LAST */
#define TIM_CHANNEL_INDEX_LAST						((timer_channel_index_t) 3U)
/** @brief Number of Timer channels available on one general-purpose Timer @def TIM_CHANNEL_COUNT */
#define TIM_CHANNEL_COUNT							((timer_channel_index_t) (TIM_CHANNEL_INDEX_LAST + 1U))
 ...
 */
#define TIM_CHANNEL_INDEX_TO_MASK(channelIndex)		((timer_channel_t) REG_BIT_MASK(channelIndex))

/** @brief No timer channel selected @def TIMx_CHANNEL_NONE */
#define TIMx_CHANNEL_NONE							((timer_channel_t) 0x00U)
...
#define TIMx_CHANNEL_ALL							((timer_channel_t) 0x0FU)
...
#define TIM_CHANNEL_MASK_HAS_ANY_CHANNEL(channelMask)	\
	(((timer_channel_t) (channelMask)) != TIMx_CHANNEL_NONE)
 ...
 */
__STATIC_FORCEINLINE timer_channel_index_t TIM_ChannelMaskToIndex(const timer_channel_t channelMask)
{
	// Local Variables
	timer_channel_t channelMaskImage = channelMask;
	timer_channel_index_t channelIndex = TIM_CHANNEL_INDEX_FIRST;
	...
	{
		channelMaskImage = (timer_channel_t) (((uint32_t) channelMaskImage) >> 1U);
		++channelIndex;
	}
 ...
 */
__STATIC_FORCEINLINE timer_channel_t TIM_ChannelMaskExtractLowestChannel(const timer_channel_t channelMask)
{
	return (timer_channel_t) (((uint32_t) channelMask) & (0UL - ((uint32_t) channelMask)));
}
...
(
	timer_channel_t* const	pChannelMask,
...
)
{
	...
	*pChannelMask = (timer_channel_t) (((uint32_t) (*pChannelMask)) & ~((uint32_t) channel));
...
#define TIMx_MODE_ALTERNATE_INTERRUPT_BOTH_COUNTING			((timer_count_mode_t) 0x03U)
...
(																					\
	(((timer_count_mode_t) (mode)) == TIMx_MODE_NORMAL) ||							\
	(((timer_count_mode_t) (mode)) == TIMx_MODE_ALTERNATE_INTERRUPT_DOWN_COUNTING) ||	\
	(((timer_count_mode_t) (mode)) == TIMx_MODE_ALTERNATE_INTERRUPT_UP_COUNTING) ||	\
	(((timer_count_mode_t) (mode)) == TIMx_MODE_ALTERNATE_INTERRUPT_BOTH_COUNTING)	\
)

/** @brief Timer counts up @def TIMx_DIR_COUNT_UP */
#define TIMx_DIR_COUNT_UP								((timer_direction_t) 0x00U)
/** @brief Timer counts down @def TIMx_DIR_COUNT_DOWN */
#define TIMx_DIR_COUNT_DOWN								((timer_direction_t) 0x01U)
...
(																\
	(((timer_direction_t) (direction)) == TIMx_DIR_COUNT_UP) ||	\
	(((timer_direction_t) (direction)) == TIMx_DIR_COUNT_DOWN)	\
)

/** @brief Disable auto-reload preload @def TIMx_ARPE_DISABLE */
#define TIMx_ARPE_DISABLE								((timer_arpe_t) 0x00U)
/** @brief Enable auto-reload preload @def TIMx_ARPE_ENABLE */
#define TIMx_ARPE_ENABLE								((timer_arpe_t) 0x01U)
...
(														\
	(((timer_arpe_t) (arpe)) == TIMx_ARPE_DISABLE) ||		\
	(((timer_arpe_t) (arpe)) == TIMx_ARPE_ENABLE)			\
)

/** @brief Disable one-pulse mode @def TIMx_OPM_DISABLE */
#define TIMx_OPM_DISABLE								((timer_opm_t) 0x00U)
/** @brief Enable one-pulse mode @def TIMx_OPM_ENABLE */
#define TIMx_OPM_ENABLE									((timer_opm_t) 0x01U)
...
(														\
	(((timer_opm_t) (onePulse)) == TIMx_OPM_DISABLE) ||	\
	(((timer_opm_t) (onePulse)) == TIMx_OPM_ENABLE)		\
)

/** @brief Update event may be generated by any update source @def TIMx_UPDATE_SOURCE_ANY */
#define TIMx_UPDATE_SOURCE_ANY							((timer_update_source_t) 0x00U)
/** @brief Update request source limited to overflow/underflow or DMA request @def TIMx_UPDATE_SOURCE_OVF_DMA */
#define TIMx_UPDATE_SOURCE_OVF_DMA						((timer_update_source_t) 0x01U)
...
(																			\
	(((timer_update_source_t) (updateSource)) == TIMx_UPDATE_SOURCE_ANY) ||	\
	(((timer_update_source_t) (updateSource)) == TIMx_UPDATE_SOURCE_OVF_DMA)	\
)

/** @brief Timer clock division is `t_DTS = t_CK_INT` @def TIMx_CKD_CLK_FREQ */
#define TIMx_CKD_CLK_FREQ								((timer_clock_division_t) 0x00U)
/** @brief Timer clock division is `t_DTS = 2 * t_CK_INT` @def TIMx_CKD_CLK_2_FREQ */
#define TIMx_CKD_CLK_2_FREQ								((timer_clock_division_t) 0x01U)
/** @brief Timer clock division is `t_DTS = 4 * t_CK_INT` @def TIMx_CKD_CLK_4_FREQ */
#define TIMx_CKD_CLK_4_FREQ								((timer_clock_division_t) 0x02U)
...
(																			\
	(((timer_clock_division_t) (clockDivision)) == TIMx_CKD_CLK_FREQ) ||		\
	(((timer_clock_division_t) (clockDivision)) == TIMx_CKD_CLK_2_FREQ) ||	\
	(((timer_clock_division_t) (clockDivision)) == TIMx_CKD_CLK_4_FREQ)		\
)
...
#define TIMx_CHANNEL_MODE_FREEZE						((timer_channel_mode_t) 0x00U)
/** @brief Set output compare output active on match @def TIMx_CHANNEL_MODE_SET_CH */
#define TIMx_CHANNEL_MODE_SET_CH						((timer_channel_mode_t) 0x01U)
/** @brief Reset output compare output inactive on match @def TIMx_CHANNEL_MODE_RESET_CH */
#define TIMx_CHANNEL_MODE_RESET_CH						((timer_channel_mode_t) 0x02U)
/** @brief Toggle output compare output on match @def TIMx_CHANNEL_MODE_TOGGLE */
#define TIMx_CHANNEL_MODE_TOGGLE						((timer_channel_mode_t) 0x03U)
/** @brief Force output compare output inactive @def TIMx_CHANNEL_MODE_FORCE_RESET */
#define TIMx_CHANNEL_MODE_FORCE_RESET					((timer_channel_mode_t) 0x04U)
/** @brief Force output compare output active @def TIMx_CHANNEL_MODE_FORCE_SET */
#define TIMx_CHANNEL_MODE_FORCE_SET						((timer_channel_mode_t) 0x05U)
/** @brief PWM mode 1 @def TIMx_CHANNEL_MODE_PWM1 */
#define TIMx_CHANNEL_MODE_PWM1							((timer_channel_mode_t) 0x06U)
/** @brief PWM mode 2 @def TIMx_CHANNEL_MODE_PWM2 */
#define TIMx_CHANNEL_MODE_PWM2							((timer_channel_mode_t) 0x07U)
...
#define TIM_CHANNEL_MODE_IS_VALID(channelMode)								\
	(((uint32_t) ((timer_channel_mode_t) (channelMode))) <= ((uint32_t) TIMx_CHANNEL_MODE_PWM2))

/** @brief Channel configured as output compare @def TIMx_CHANNEL_CCS_OUTPUT */
#define TIMx_CHANNEL_CCS_OUTPUT						((timer_channel_ccs_t) 0x00U)
/** @brief Input capture maps ICx to TIx @def TIMx_CHANNEL_CCS_INPUT_TIx */
#define TIMx_CHANNEL_CCS_INPUT_TIx					((timer_channel_ccs_t) 0x01U)
/** @brief Input capture maps ICx to adjacent TI input @def TIMx_CHANNEL_CCS_INPUT_TIx_1 */
#define TIMx_CHANNEL_CCS_INPUT_TIx_1				((timer_channel_ccs_t) 0x02U)
/** @brief Input capture maps ICx to TRC @def TIMx_CHANNEL_CCS_INPUT_TRC */
#define TIMx_CHANNEL_CCS_INPUT_TRC					((timer_channel_ccs_t) 0x03U)
...
#define TIM_CHANNEL_CCS_IS_VALID(ccs)										\
	(((uint32_t) ((timer_channel_ccs_t) (ccs))) <= ((uint32_t) TIMx_CHANNEL_CCS_INPUT_TRC))

/** @brief Disable output compare preload @def TIMx_CHANNEL_OC_PRELOAD_DISABLE */
#define TIMx_CHANNEL_OC_PRELOAD_DISABLE				((timer_channel_oc_preload_t) 0x00U)
/** @brief Enable output compare preload @def TIMx_CHANNEL_OC_PRELOAD_ENABLE */
#define TIMx_CHANNEL_OC_PRELOAD_ENABLE				((timer_channel_oc_preload_t) 0x01U)
...
(																						\
	(((timer_channel_oc_preload_t) (ocPreload)) == TIMx_CHANNEL_OC_PRELOAD_DISABLE) ||	\
	(((timer_channel_oc_preload_t) (ocPreload)) == TIMx_CHANNEL_OC_PRELOAD_ENABLE)		\
)

/** @brief Disable output compare fast mode @def TIMx_CHANNEL_OC_FAST_DISABLE */
#define TIMx_CHANNEL_OC_FAST_DISABLE					((timer_channel_oc_fast_t) 0x00U)
/** @brief Enable output compare fast mode @def TIMx_CHANNEL_OC_FAST_ENABLE */
#define TIMx_CHANNEL_OC_FAST_ENABLE						((timer_channel_oc_fast_t) 0x01U)
...
(																			\
	(((timer_channel_oc_fast_t) (ocFast)) == TIMx_CHANNEL_OC_FAST_DISABLE) ||	\
	(((timer_channel_oc_fast_t) (ocFast)) == TIMx_CHANNEL_OC_FAST_ENABLE)		\
)

/** @brief Disable output compare clear mode @def TIMx_CHANNEL_OC_CLEAR_DISABLE */
#define TIMx_CHANNEL_OC_CLEAR_DISABLE					((timer_channel_oc_clear_t) 0x00U)
/** @brief Enable output compare clear mode @def TIMx_CHANNEL_OC_CLEAR_ENABLE */
#define TIMx_CHANNEL_OC_CLEAR_ENABLE					((timer_channel_oc_clear_t) 0x01U)
...
(																				\
	(((timer_channel_oc_clear_t) (ocClear)) == TIMx_CHANNEL_OC_CLEAR_DISABLE) ||	\
	(((timer_channel_oc_clear_t) (ocClear)) == TIMx_CHANNEL_OC_CLEAR_ENABLE)		\
)

/** @brief Channel active-high polarity @def TIMx_CHANNEL_POLARITY_HIGH */
#define TIMx_CHANNEL_POLARITY_HIGH						((timer_channel_polarity_t) 0x00U)
/** @brief Channel active-low polarity @def TIMx_CHANNEL_POLARITY_LOW */
#define TIMx_CHANNEL_POLARITY_LOW						((timer_channel_polarity_t) 0x01U)
...
(																				\
	(((timer_channel_polarity_t) (polarity)) == TIMx_CHANNEL_POLARITY_HIGH) ||	\
	(((timer_channel_polarity_t) (polarity)) == TIMx_CHANNEL_POLARITY_LOW)		\
)
...
#define TIMx_IRQ_DISABLE							((timer_irq_enable_t) 0x00U)
/** @brief Timer IRQ enabled selector @def TIMx_IRQ_ENABLE */
#define TIMx_IRQ_ENABLE								((timer_irq_enable_t) 0x01U)
...
#define TIMx_IRQ_ALL								((timer_irq_t) 0x1FU)
...
#define TIM_IRQ_MASK_HAS_ANY_IRQ(irqMask)			\
	(((timer_irq_t) (irqMask)) != ((timer_irq_t) 0x00U))
...
#define TIM_DMA_MASK_IS_VALID(dmaMask)			\
	((((timer_dma_t) (dmaMask)) != ((timer_dma_t) 0x00U)) && ((((uint32_t) (dmaMask)) & (~((uint32_t) TIMx_DMA_ALL))) == 0x00000000UL))
...
#define TIM_MASTER_MODE_IS_VALID(masterMode)		\
	(((uint32_t) ((timer_master_mode_t) (masterMode))) <= ((uint32_t) TIMx_MMS_CMP_OC4REF))

/** @brief Slave mode disabled @def TIMx_SMS_DISABLE */
#define TIMx_SMS_DISABLE							((timer_slave_mode_t) 0x00U)
/** @brief Encoder mode 1 @def TIMx_SMS_ENC_MODE1 */
#define TIMx_SMS_ENC_MODE1							((timer_slave_mode_t) 0x01U)
/** @brief Encoder mode 2 @def TIMx_SMS_ENC_MODE2 */
#define TIMx_SMS_ENC_MODE2							((timer_slave_mode_t) 0x02U)
/** @brief Encoder mode 3 @def TIMx_SMS_ENC_MODE3 */
#define TIMx_SMS_ENC_MODE3							((timer_slave_mode_t) 0x03U)
...
#define TIM_SLAVE_MODE_IS_VALID(slaveMode)			\
	(((uint32_t) ((timer_slave_mode_t) (slaveMode))) <= ((uint32_t) TIMx_SMS_ENC_MODE3))
...
#define TIM2_PARTIAL2_REMAP							((timer_remap_t) 0x02U)
