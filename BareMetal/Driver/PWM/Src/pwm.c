...
void PWM_GPIO_Config(pwm_handle_t PWM_HANDLE){
	...
	GPIO_Init
	(
		PWM_HANDLE->PWM_CONFIG.GPIOx_CONFIG.GPIO,
		PWM_HANDLE->PWM_CONFIG.GPIOx_CONFIG.PIN,
		PWM_HANDLE->PWM_CONFIG.GPIOx_CONFIG.MODE,
		PWM_HANDLE->PWM_CONFIG.GPIOx_CONFIG.CNF
	);
}
