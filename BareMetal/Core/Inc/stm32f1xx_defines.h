...
/** @brief Register-positioned mask for the `RDP_KEY` field @def RDP_KEY_Msk */
...
/** @brief Register-positioned mask for the `FLASH_KEY1` field @def FLASH_KEY1_Msk */
...
/** @brief Register-positioned mask for the `FLASH_KEY2` field @def FLASH_KEY2_Msk */
