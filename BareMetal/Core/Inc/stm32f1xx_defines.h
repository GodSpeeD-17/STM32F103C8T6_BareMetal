...
// ==================================================================================================== //
//									ARM Cortex-M3 Core Register Defines									//
// ==================================================================================================== //

// ---------------------------- SysTick Control / Status Register Defines ----------------------------- //
/** @brief SysTick CTRL: ENABLE Position @def SysTick_CTRL_ENABLE_Pos */
#define SysTick_CTRL_ENABLE_Pos			((reg_bit_pos_t) 0U)
/** @brief SysTick CTRL: ENABLE Mask @def SysTick_CTRL_ENABLE_Msk */
#define SysTick_CTRL_ENABLE_Msk			REG_BIT_MASK(SysTick_CTRL_ENABLE_Pos)
/** @brief `SysTick_CTRL_ENABLE` field mask alias @def SysTick_CTRL_ENABLE */
#define SysTick_CTRL_ENABLE				SysTick_CTRL_ENABLE_Msk

/** @brief SysTick CTRL: TICKINT Position @def SysTick_CTRL_TICKINT_Pos */
#define SysTick_CTRL_TICKINT_Pos		((reg_bit_pos_t) 1U)
/** @brief SysTick CTRL: TICKINT Mask @def SysTick_CTRL_TICKINT_Msk */
#define SysTick_CTRL_TICKINT_Msk		REG_BIT_MASK(SysTick_CTRL_TICKINT_Pos)
/** @brief `SysTick_CTRL_TICKINT` field mask alias @def SysTick_CTRL_TICKINT */
#define SysTick_CTRL_TICKINT			SysTick_CTRL_TICKINT_Msk

/** @brief SysTick CTRL: CLKSOURCE Position @def SysTick_CTRL_CLKSOURCE_Pos */
#define SysTick_CTRL_CLKSOURCE_Pos		((reg_bit_pos_t) 2U)
/** @brief SysTick CTRL: CLKSOURCE Mask @def SysTick_CTRL_CLKSOURCE_Msk */
#define SysTick_CTRL_CLKSOURCE_Msk		REG_BIT_MASK(SysTick_CTRL_CLKSOURCE_Pos)
/** @brief `SysTick_CTRL_CLKSOURCE` field mask alias @def SysTick_CTRL_CLKSOURCE */
#define SysTick_CTRL_CLKSOURCE			SysTick_CTRL_CLKSOURCE_Msk

/** @brief SysTick CTRL: COUNTFLAG Position @def SysTick_CTRL_COUNTFLAG_Pos */
#define SysTick_CTRL_COUNTFLAG_Pos		((reg_bit_pos_t) 16U)
/** @brief SysTick CTRL: COUNTFLAG Mask @def SysTick_CTRL_COUNTFLAG_Msk */
#define SysTick_CTRL_COUNTFLAG_Msk		REG_BIT_MASK(SysTick_CTRL_COUNTFLAG_Pos)
/** @brief `SysTick_CTRL_COUNTFLAG` field mask alias @def SysTick_CTRL_COUNTFLAG */
#define SysTick_CTRL_COUNTFLAG			SysTick_CTRL_COUNTFLAG_Msk

// --------------------------------- SysTick Reload Register Defines ---------------------------------- //
/** @brief SysTick LOAD: RELOAD Position @def SysTick_LOAD_RELOAD_Pos */
#define SysTick_LOAD_RELOAD_Pos			((reg_bit_pos_t) 0U)
/** @brief Width of the `SysTick_LOAD_RELOAD` field @def SysTick_LOAD_RELOAD_Width */
#define SysTick_LOAD_RELOAD_Width		((reg_field_width_t) 24U)
/** @brief SysTick LOAD: RELOAD Mask @def SysTick_LOAD_RELOAD_Msk */
#define SysTick_LOAD_RELOAD_Msk			REG_FIELD_MASK(SysTick_LOAD_RELOAD_Pos, SysTick_LOAD_RELOAD_Width)
/** @brief `SysTick_LOAD_RELOAD` field mask alias @def SysTick_LOAD_RELOAD */
#define SysTick_LOAD_RELOAD				SysTick_LOAD_RELOAD_Msk

// --------------------------------- SysTick Current Register Defines --------------------------------- //
/** @brief SysTick VAL: CURRENT Position @def SysTick_VAL_CURRENT_Pos */
#define SysTick_VAL_CURRENT_Pos			((reg_bit_pos_t) 0U)
/** @brief Width of the `SysTick_VAL_CURRENT` field @def SysTick_VAL_CURRENT_Width */
#define SysTick_VAL_CURRENT_Width		((reg_field_width_t) 24U)
/** @brief SysTick VAL: CURRENT Mask @def SysTick_VAL_CURRENT_Msk */
#define SysTick_VAL_CURRENT_Msk			REG_FIELD_MASK(SysTick_VAL_CURRENT_Pos, SysTick_VAL_CURRENT_Width)
/** @brief `SysTick_VAL_CURRENT` field mask alias @def SysTick_VAL_CURRENT */
#define SysTick_VAL_CURRENT				SysTick_VAL_CURRENT_Msk

// ------------------------------- SysTick Calibration Register Defines ------------------------------- //
/** @brief SysTick CALIB: TENMS Position @def SysTick_CALIB_TENMS_Pos */
#define SysTick_CALIB_TENMS_Pos			((reg_bit_pos_t) 0U)
/** @brief Width of the `SysTick_CALIB_TENMS` field @def SysTick_CALIB_TENMS_Width */
#define SysTick_CALIB_TENMS_Width		((reg_field_width_t) 24U)
/** @brief SysTick CALIB: TENMS Mask @def SysTick_CALIB_TENMS_Msk */
#define SysTick_CALIB_TENMS_Msk			REG_FIELD_MASK(SysTick_CALIB_TENMS_Pos, SysTick_CALIB_TENMS_Width)
/** @brief `SysTick_CALIB_TENMS` field mask alias @def SysTick_CALIB_TENMS */
#define SysTick_CALIB_TENMS				SysTick_CALIB_TENMS_Msk

/** @brief SysTick CALIB: SKEW Position @def SysTick_CALIB_SKEW_Pos */
#define SysTick_CALIB_SKEW_Pos			((reg_bit_pos_t) 30U)
/** @brief SysTick CALIB: SKEW Mask @def SysTick_CALIB_SKEW_Msk */
#define SysTick_CALIB_SKEW_Msk			REG_BIT_MASK(SysTick_CALIB_SKEW_Pos)
/** @brief `SysTick_CALIB_SKEW` field mask alias @def SysTick_CALIB_SKEW */
#define SysTick_CALIB_SKEW				SysTick_CALIB_SKEW_Msk

/** @brief SysTick CALIB: NOREF Position @def SysTick_CALIB_NOREF_Pos */
#define SysTick_CALIB_NOREF_Pos			((reg_bit_pos_t) 31U)
/** @brief SysTick CALIB: NOREF Mask @def SysTick_CALIB_NOREF_Msk */
#define SysTick_CALIB_NOREF_Msk			REG_BIT_MASK(SysTick_CALIB_NOREF_Pos)
/** @brief `SysTick_CALIB_NOREF` field mask alias @def SysTick_CALIB_NOREF */
