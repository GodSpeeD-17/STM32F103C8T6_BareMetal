...
#define AFIO_EVCR_PIN_Msk					(REG_FIELD_VALUE(AFIO_EVCR_PIN_Pos, 0xFUL))
...
#define AFIO_EVCR_PIN_0						(REG_FIELD_VALUE(AFIO_EVCR_PIN_Pos, 0x1UL))
/** @brief PIN bit 1 @def AFIO_EVCR_PIN_1 */
#define AFIO_EVCR_PIN_1						(REG_FIELD_VALUE(AFIO_EVCR_PIN_Pos, 0x2UL))
/** @brief PIN bit 2 @def AFIO_EVCR_PIN_2 */
#define AFIO_EVCR_PIN_2						(REG_FIELD_VALUE(AFIO_EVCR_PIN_Pos, 0x4UL))
/** @brief PIN bit 3 @def AFIO_EVCR_PIN_3 */
#define AFIO_EVCR_PIN_3						(REG_FIELD_VALUE(AFIO_EVCR_PIN_Pos, 0x8UL))
...
#define AFIO_EVCR_PORT_Msk					(REG_FIELD_VALUE(AFIO_EVCR_PORT_Pos, 0x7UL))
...
#define AFIO_EVCR_PORT_0					(REG_FIELD_VALUE(AFIO_EVCR_PORT_Pos, 0x1UL))
/** @brief PORT bit 1 @def AFIO_EVCR_PORT_1 */
#define AFIO_EVCR_PORT_1					(REG_FIELD_VALUE(AFIO_EVCR_PORT_Pos, 0x2UL))
/** @brief PORT bit 2 @def AFIO_EVCR_PORT_2 */
#define AFIO_EVCR_PORT_2					(REG_FIELD_VALUE(AFIO_EVCR_PORT_Pos, 0x4UL))
...
#define AFIO_EVCR_EVOE_Msk					(REG_FIELD_VALUE(AFIO_EVCR_EVOE_Pos, 0x1UL))
...
#define AFIO_MAPR_SPI1_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_SPI1_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_I2C1_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_I2C1_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_USART1_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_USART1_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_USART2_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_USART2_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_USART3_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_USART3_REMAP_Pos, 0x3UL))
...
#define AFIO_MAPR_USART3_REMAP_0			(REG_FIELD_VALUE(AFIO_MAPR_USART3_REMAP_Pos, 0x1UL))
/** @brief USART3_REMAP bit 1 @def AFIO_MAPR_USART3_REMAP_1 */
#define AFIO_MAPR_USART3_REMAP_1			(REG_FIELD_VALUE(AFIO_MAPR_USART3_REMAP_Pos, 0x2UL))
...
#define AFIO_MAPR_TIM1_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_TIM1_REMAP_Pos, 0x3UL))
...
#define AFIO_MAPR_TIM1_REMAP_0				(REG_FIELD_VALUE(AFIO_MAPR_TIM1_REMAP_Pos, 0x1UL))
/** @brief TIM1_REMAP bit 1 @def AFIO_MAPR_TIM1_REMAP_1 */
#define AFIO_MAPR_TIM1_REMAP_1				(REG_FIELD_VALUE(AFIO_MAPR_TIM1_REMAP_Pos, 0x2UL))
...
#define AFIO_MAPR_TIM2_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_TIM2_REMAP_Pos, 0x3UL))
...
#define AFIO_MAPR_TIM2_REMAP_0				(REG_FIELD_VALUE(AFIO_MAPR_TIM2_REMAP_Pos, 0x1UL))
/** @brief TIM2_REMAP bit 1 @def AFIO_MAPR_TIM2_REMAP_1 */
#define AFIO_MAPR_TIM2_REMAP_1				(REG_FIELD_VALUE(AFIO_MAPR_TIM2_REMAP_Pos, 0x2UL))
...
#define AFIO_MAPR_TIM3_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_TIM3_REMAP_Pos, 0x3UL))
...
#define AFIO_MAPR_TIM3_REMAP_0				(REG_FIELD_VALUE(AFIO_MAPR_TIM3_REMAP_Pos, 0x1UL))
/** @brief TIM3_REMAP bit 1 @def AFIO_MAPR_TIM3_REMAP_1 */
#define AFIO_MAPR_TIM3_REMAP_1				(REG_FIELD_VALUE(AFIO_MAPR_TIM3_REMAP_Pos, 0x2UL))
...
#define AFIO_MAPR_TIM4_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_TIM4_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_CAN_REMAP_Msk				(REG_FIELD_VALUE(AFIO_MAPR_CAN_REMAP_Pos, 0x3UL))
...
#define AFIO_MAPR_CAN_REMAP_0				(REG_FIELD_VALUE(AFIO_MAPR_CAN_REMAP_Pos, 0x1UL))
/** @brief CAN_REMAP bit 1 @def AFIO_MAPR_CAN_REMAP_1 */
#define AFIO_MAPR_CAN_REMAP_1				(REG_FIELD_VALUE(AFIO_MAPR_CAN_REMAP_Pos, 0x2UL))
...
#define AFIO_MAPR_PD01_REMAP_Msk			(REG_FIELD_VALUE(AFIO_MAPR_PD01_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_TIM5CH4_IREMAP_Msk		(REG_FIELD_VALUE(AFIO_MAPR_TIM5CH4_IREMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_ADC1_ETRGINJ_REMAP_Msk	(REG_FIELD_VALUE(AFIO_MAPR_ADC1_ETRGINJ_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_ADC1_ETGREG_REMAP_Msk		(REG_FIELD_VALUE(AFIO_MAPR_ADC1_ETGREG_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_ADC2_ETRGINJ_REMAP_Msk	(REG_FIELD_VALUE(AFIO_MAPR_ADC2_ETRGINJ_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_ADC2_ETGREG_REMAP_Msk		(REG_FIELD_VALUE(AFIO_MAPR_ADC2_ETGREG_REMAP_Pos, 0x1UL))
...
#define AFIO_MAPR_SWJ_CFG_Msk				(REG_FIELD_VALUE(AFIO_MAPR_SWJ_CFG_Pos, 0x7UL))
...
#define AFIO_MAPR_SWJ_CFG_0					(REG_FIELD_VALUE(AFIO_MAPR_SWJ_CFG_Pos, 0x1UL))
/** @brief SWJ_CFG bit 1 @def AFIO_MAPR_SWJ_CFG_1 */
#define AFIO_MAPR_SWJ_CFG_1					(REG_FIELD_VALUE(AFIO_MAPR_SWJ_CFG_Pos, 0x2UL))
/** @brief SWJ_CFG bit 2 @def AFIO_MAPR_SWJ_CFG_2 */
#define AFIO_MAPR_SWJ_CFG_2					(REG_FIELD_VALUE(AFIO_MAPR_SWJ_CFG_Pos, 0x4UL))

/** @} */ // AFIO_01_RegisterLayer_02_RemapDebug

// ------------------------------------------------------------------------------------------
// AFIO_EXTICR Raw Port-Source Field Encodings
// ------------------------------------------------------------------------------------------

/**
 * @brief AFIO EXTICR Raw Port-Source Field Encodings
 * @defgroup AFIO_01_RegisterLayer_03_ExtiConfigEncoding AFIO EXTICR Port-Source Field Encodings
 * @ingroup AFIO_01_RegisterLayer
 * @details
 * These definitions expose the right-aligned hardware values used by each
 * `EXTIx[3:0]` field inside `AFIO_EXTICR1` through `AFIO_EXTICR4`. They are
 * intentionally raw register-field values; driver-facing GPIO instances are
 * translated by the GPIO IRQ codec.
 * @{
 */

// ------ EXTIx[3:0] Raw Port-Source Values ------ //
/** @brief GPIOA raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOA */
#define AFIO_EXTICR_PORT_SOURCE_GPIOA		((reg_field_t) 0x00U)
/** @brief GPIOB raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOB */
#define AFIO_EXTICR_PORT_SOURCE_GPIOB		((reg_field_t) 0x01U)
/** @brief GPIOC raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOC */
#define AFIO_EXTICR_PORT_SOURCE_GPIOC		((reg_field_t) 0x02U)
/** @brief GPIOD raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOD */
#define AFIO_EXTICR_PORT_SOURCE_GPIOD		((reg_field_t) 0x03U)
/** @brief GPIOE raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOE */
#define AFIO_EXTICR_PORT_SOURCE_GPIOE		((reg_field_t) 0x04U)
/** @brief GPIOF raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOF */
#define AFIO_EXTICR_PORT_SOURCE_GPIOF		((reg_field_t) 0x05U)
/** @brief GPIOG raw AFIO EXTICR port-source value @def AFIO_EXTICR_PORT_SOURCE_GPIOG */
#define AFIO_EXTICR_PORT_SOURCE_GPIOG		((reg_field_t) 0x06U)

/** @} */ // AFIO_01_RegisterLayer_03_ExtiConfigEncoding
...
#define AFIO_EXTICR1_EXTI0_Msk				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI0_Pos, 0xFUL))
...
#define AFIO_EXTICR1_EXTI0_0				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI0_Pos, 0x1UL))
/** @brief EXTI0 bit 1 @def AFIO_EXTICR1_EXTI0_1 */
#define AFIO_EXTICR1_EXTI0_1				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI0_Pos, 0x2UL))
/** @brief EXTI0 bit 2 @def AFIO_EXTICR1_EXTI0_2 */
#define AFIO_EXTICR1_EXTI0_2				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI0_Pos, 0x4UL))
/** @brief EXTI0 bit 3 @def AFIO_EXTICR1_EXTI0_3 */
#define AFIO_EXTICR1_EXTI0_3				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI0_Pos, 0x8UL))
...
#define AFIO_EXTICR1_EXTI1_Msk				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI1_Pos, 0xFUL))
...
#define AFIO_EXTICR1_EXTI1_0				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI1_Pos, 0x1UL))
/** @brief EXTI1 bit 1 @def AFIO_EXTICR1_EXTI1_1 */
#define AFIO_EXTICR1_EXTI1_1				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI1_Pos, 0x2UL))
/** @brief EXTI1 bit 2 @def AFIO_EXTICR1_EXTI1_2 */
#define AFIO_EXTICR1_EXTI1_2				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI1_Pos, 0x4UL))
/** @brief EXTI1 bit 3 @def AFIO_EXTICR1_EXTI1_3 */
#define AFIO_EXTICR1_EXTI1_3				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI1_Pos, 0x8UL))
...
#define AFIO_EXTICR1_EXTI2_Msk				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI2_Pos, 0xFUL))
...
#define AFIO_EXTICR1_EXTI2_0				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI2_Pos, 0x1UL))
/** @brief EXTI2 bit 1 @def AFIO_EXTICR1_EXTI2_1 */
#define AFIO_EXTICR1_EXTI2_1				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI2_Pos, 0x2UL))
/** @brief EXTI2 bit 2 @def AFIO_EXTICR1_EXTI2_2 */
#define AFIO_EXTICR1_EXTI2_2				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI2_Pos, 0x4UL))
/** @brief EXTI2 bit 3 @def AFIO_EXTICR1_EXTI2_3 */
#define AFIO_EXTICR1_EXTI2_3				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI2_Pos, 0x8UL))
...
#define AFIO_EXTICR1_EXTI3_Msk				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI3_Pos, 0xFUL))
...
#define AFIO_EXTICR1_EXTI3_0				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI3_Pos, 0x1UL))
/** @brief EXTI3 bit 1 @def AFIO_EXTICR1_EXTI3_1 */
#define AFIO_EXTICR1_EXTI3_1				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI3_Pos, 0x2UL))
/** @brief EXTI3 bit 2 @def AFIO_EXTICR1_EXTI3_2 */
#define AFIO_EXTICR1_EXTI3_2				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI3_Pos, 0x4UL))
/** @brief EXTI3 bit 3 @def AFIO_EXTICR1_EXTI3_3 */
#define AFIO_EXTICR1_EXTI3_3				(REG_FIELD_VALUE(AFIO_EXTICR1_EXTI3_Pos, 0x8UL))
...
#define AFIO_EXTICR2_EXTI4_Msk				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI4_Pos, 0xFUL))
...
#define AFIO_EXTICR2_EXTI4_0				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI4_Pos, 0x1UL))
/** @brief EXTI4 bit 1 @def AFIO_EXTICR2_EXTI4_1 */
#define AFIO_EXTICR2_EXTI4_1				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI4_Pos, 0x2UL))
/** @brief EXTI4 bit 2 @def AFIO_EXTICR2_EXTI4_2 */
#define AFIO_EXTICR2_EXTI4_2				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI4_Pos, 0x4UL))
/** @brief EXTI4 bit 3 @def AFIO_EXTICR2_EXTI4_3 */
#define AFIO_EXTICR2_EXTI4_3				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI4_Pos, 0x8UL))
...
#define AFIO_EXTICR2_EXTI5_Msk				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI5_Pos, 0xFUL))
...
#define AFIO_EXTICR2_EXTI5_0				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI5_Pos, 0x1UL))
/** @brief EXTI5 bit 1 @def AFIO_EXTICR2_EXTI5_1 */
#define AFIO_EXTICR2_EXTI5_1				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI5_Pos, 0x2UL))
/** @brief EXTI5 bit 2 @def AFIO_EXTICR2_EXTI5_2 */
#define AFIO_EXTICR2_EXTI5_2				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI5_Pos, 0x4UL))
/** @brief EXTI5 bit 3 @def AFIO_EXTICR2_EXTI5_3 */
#define AFIO_EXTICR2_EXTI5_3				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI5_Pos, 0x8UL))
...
#define AFIO_EXTICR2_EXTI6_Msk				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI6_Pos, 0xFUL))
...
#define AFIO_EXTICR2_EXTI6_0				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI6_Pos, 0x1UL))
/** @brief EXTI6 bit 1 @def AFIO_EXTICR2_EXTI6_1 */
#define AFIO_EXTICR2_EXTI6_1				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI6_Pos, 0x2UL))
/** @brief EXTI6 bit 2 @def AFIO_EXTICR2_EXTI6_2 */
#define AFIO_EXTICR2_EXTI6_2				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI6_Pos, 0x4UL))
/** @brief EXTI6 bit 3 @def AFIO_EXTICR2_EXTI6_3 */
#define AFIO_EXTICR2_EXTI6_3				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI6_Pos, 0x8UL))
...
#define AFIO_EXTICR2_EXTI7_Msk				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI7_Pos, 0xFUL))
...
#define AFIO_EXTICR2_EXTI7_0				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI7_Pos, 0x1UL))
/** @brief EXTI7 bit 1 @def AFIO_EXTICR2_EXTI7_1 */
#define AFIO_EXTICR2_EXTI7_1				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI7_Pos, 0x2UL))
/** @brief EXTI7 bit 2 @def AFIO_EXTICR2_EXTI7_2 */
#define AFIO_EXTICR2_EXTI7_2				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI7_Pos, 0x4UL))
/** @brief EXTI7 bit 3 @def AFIO_EXTICR2_EXTI7_3 */
#define AFIO_EXTICR2_EXTI7_3				(REG_FIELD_VALUE(AFIO_EXTICR2_EXTI7_Pos, 0x8UL))
...
#define AFIO_EXTICR3_EXTI8_Msk				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI8_Pos, 0xFUL))
...
#define AFIO_EXTICR3_EXTI8_0				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI8_Pos, 0x1UL))
/** @brief EXTI8 bit 1 @def AFIO_EXTICR3_EXTI8_1 */
#define AFIO_EXTICR3_EXTI8_1				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI8_Pos, 0x2UL))
/** @brief EXTI8 bit 2 @def AFIO_EXTICR3_EXTI8_2 */
#define AFIO_EXTICR3_EXTI8_2				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI8_Pos, 0x4UL))
/** @brief EXTI8 bit 3 @def AFIO_EXTICR3_EXTI8_3 */
#define AFIO_EXTICR3_EXTI8_3				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI8_Pos, 0x8UL))
...
#define AFIO_EXTICR3_EXTI9_Msk				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI9_Pos, 0xFUL))
...
#define AFIO_EXTICR3_EXTI9_0				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI9_Pos, 0x1UL))
/** @brief EXTI9 bit 1 @def AFIO_EXTICR3_EXTI9_1 */
#define AFIO_EXTICR3_EXTI9_1				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI9_Pos, 0x2UL))
/** @brief EXTI9 bit 2 @def AFIO_EXTICR3_EXTI9_2 */
#define AFIO_EXTICR3_EXTI9_2				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI9_Pos, 0x4UL))
/** @brief EXTI9 bit 3 @def AFIO_EXTICR3_EXTI9_3 */
#define AFIO_EXTICR3_EXTI9_3				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI9_Pos, 0x8UL))
...
#define AFIO_EXTICR3_EXTI10_Msk				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI10_Pos, 0xFUL))
...
#define AFIO_EXTICR3_EXTI10_0				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI10_Pos, 0x1UL))
/** @brief EXTI10 bit 1 @def AFIO_EXTICR3_EXTI10_1 */
#define AFIO_EXTICR3_EXTI10_1				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI10_Pos, 0x2UL))
/** @brief EXTI10 bit 2 @def AFIO_EXTICR3_EXTI10_2 */
#define AFIO_EXTICR3_EXTI10_2				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI10_Pos, 0x4UL))
/** @brief EXTI10 bit 3 @def AFIO_EXTICR3_EXTI10_3 */
#define AFIO_EXTICR3_EXTI10_3				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI10_Pos, 0x8UL))
...
#define AFIO_EXTICR3_EXTI11_Msk				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI11_Pos, 0xFUL))
...
#define AFIO_EXTICR3_EXTI11_0				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI11_Pos, 0x1UL))
/** @brief EXTI11 bit 1 @def AFIO_EXTICR3_EXTI11_1 */
#define AFIO_EXTICR3_EXTI11_1				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI11_Pos, 0x2UL))
/** @brief EXTI11 bit 2 @def AFIO_EXTICR3_EXTI11_2 */
#define AFIO_EXTICR3_EXTI11_2				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI11_Pos, 0x4UL))
/** @brief EXTI11 bit 3 @def AFIO_EXTICR3_EXTI11_3 */
#define AFIO_EXTICR3_EXTI11_3				(REG_FIELD_VALUE(AFIO_EXTICR3_EXTI11_Pos, 0x8UL))
...
#define AFIO_EXTICR4_EXTI12_Msk				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI12_Pos, 0xFUL))
...
#define AFIO_EXTICR4_EXTI12_0				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI12_Pos, 0x1UL))
/** @brief EXTI12 bit 1 @def AFIO_EXTICR4_EXTI12_1 */
#define AFIO_EXTICR4_EXTI12_1				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI12_Pos, 0x2UL))
/** @brief EXTI12 bit 2 @def AFIO_EXTICR4_EXTI12_2 */
#define AFIO_EXTICR4_EXTI12_2				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI12_Pos, 0x4UL))
/** @brief EXTI12 bit 3 @def AFIO_EXTICR4_EXTI12_3 */
#define AFIO_EXTICR4_EXTI12_3				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI12_Pos, 0x8UL))
...
#define AFIO_EXTICR4_EXTI13_Msk				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI13_Pos, 0xFUL))
...
#define AFIO_EXTICR4_EXTI13_0				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI13_Pos, 0x1UL))
/** @brief EXTI13 bit 1 @def AFIO_EXTICR4_EXTI13_1 */
#define AFIO_EXTICR4_EXTI13_1				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI13_Pos, 0x2UL))
/** @brief EXTI13 bit 2 @def AFIO_EXTICR4_EXTI13_2 */
#define AFIO_EXTICR4_EXTI13_2				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI13_Pos, 0x4UL))
/** @brief EXTI13 bit 3 @def AFIO_EXTICR4_EXTI13_3 */
#define AFIO_EXTICR4_EXTI13_3				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI13_Pos, 0x8UL))
...
#define AFIO_EXTICR4_EXTI14_Msk				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI14_Pos, 0xFUL))
...
#define AFIO_EXTICR4_EXTI14_0				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI14_Pos, 0x1UL))
/** @brief EXTI14 bit 1 @def AFIO_EXTICR4_EXTI14_1 */
#define AFIO_EXTICR4_EXTI14_1				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI14_Pos, 0x2UL))
/** @brief EXTI14 bit 2 @def AFIO_EXTICR4_EXTI14_2 */
#define AFIO_EXTICR4_EXTI14_2				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI14_Pos, 0x4UL))
/** @brief EXTI14 bit 3 @def AFIO_EXTICR4_EXTI14_3 */
#define AFIO_EXTICR4_EXTI14_3				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI14_Pos, 0x8UL))
...
#define AFIO_EXTICR4_EXTI15_Msk				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI15_Pos, 0xFUL))
...
#define AFIO_EXTICR4_EXTI15_0				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI15_Pos, 0x1UL))
/** @brief EXTI15 bit 1 @def AFIO_EXTICR4_EXTI15_1 */
#define AFIO_EXTICR4_EXTI15_1				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI15_Pos, 0x2UL))
/** @brief EXTI15 bit 2 @def AFIO_EXTICR4_EXTI15_2 */
#define AFIO_EXTICR4_EXTI15_2				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI15_Pos, 0x4UL))
/** @brief EXTI15 bit 3 @def AFIO_EXTICR4_EXTI15_3 */
#define AFIO_EXTICR4_EXTI15_3				(REG_FIELD_VALUE(AFIO_EXTICR4_EXTI15_Pos, 0x8UL))
