...
#define NVIC_BASE_ADDR							((uintptr_t) 0xE000E100UL)
/** @brief System Control Block Base @def SCB_BASE_ADDR */
#define SCB_BASE_ADDR							((uintptr_t) 0xE000ED00UL)
/** @brief Core Debug Registers Base @def CoreDebug_BASE_ADDR */
#define CoreDebug_BASE_ADDR						((uintptr_t) 0xE000EDF0UL)
...
#define APB2_BASE_ADDR							((uintptr_t) 0x40010000UL)
/** @brief AHB Peripheral Base (Memory, DMA, CRC) @def AHB_BASE_ADDR @def AHB_BASE_ADDR */
#define AHB_BASE_ADDR							((uintptr_t) 0x40018000UL)
...
#define DMA2_BASE_ADDR							((uintptr_t) (AHB_BASE_ADDR + DMA2_OFFSET))
/** @brief RCC Peripheral Base Address @def RCC_BASE_ADDRESS  */
#define RCC_BASE_ADDRESS						((uintptr_t) (AHB_BASE_ADDR + RCC_OFFSET))
/** @brief Flash Memory Interface Base @def FLASH_BASE_ADDR */
#define FLASH_BASE_ADDR							((uintptr_t) (AHB_BASE_ADDR + FLASH_OFFSET))
...
#define TIM3_BASE_ADDRESS						((uintptr_t) (APB1_BASE_ADDR + TIM3_OFFSET))
/** @brief General-purpose Timer 4 Base Memory Address @def TIM4_BASE_ADDRESS */
#define TIM4_BASE_ADDRESS						((uintptr_t) (APB1_BASE_ADDR + TIM4_OFFSET))
/** @brief General-purpose Timer 5 Base Memory Address @def TIM5_BASE_ADDRESS */
#define TIM5_BASE_ADDRESS						((uintptr_t) (APB1_BASE_ADDR + TIM5_OFFSET))
...
#define USART3_BASE_ADDRESS						((uintptr_t) (APB1_BASE_ADDR + USART3_OFFSET))
...
#define AFIO_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + AFIO_OFFSET))
/** @brief EXTI Base Memory Address @def EXTI_BASE_ADDRESS */
#define EXTI_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + EXTI_OFFSET))
/** @brief GPIOA Base Memory Address @def GPIOA_BASE_ADDRESS */
#define GPIOA_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOA_OFFSET))
/** @brief GPIOB Base Memory Address @def GPIOB_BASE_ADDRESS */
#define GPIOB_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOB_OFFSET))
/** @brief GPIOC Base Memory Address @def GPIOC_BASE_ADDRESS */
#define GPIOC_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOC_OFFSET))
/** @brief GPIOD Base Memory Address @def GPIOD_BASE_ADDRESS */
#define GPIOD_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOD_OFFSET))
/** @brief GPIOE Base Memory Address @def GPIOE_BASE_ADDRESS */
#define GPIOE_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOE_OFFSET))
/** @brief GPIOF Base Memory Address @def GPIOF_BASE_ADDRESS */
#define GPIOF_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOF_OFFSET))
/** @brief GPIOG Base Memory Address @def GPIOG_BASE_ADDRESS */
#define GPIOG_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + GPIOG_OFFSET))
/** @brief ADC1 Base Memory Address @def ADC1_BASE_ADDRESS */
#define ADC1_BASE_ADDRESS						((uintptr_t) (APB2_BASE_ADDR + ADC1_OFFSET))
