 ...
 * @file	app_time.h
 * @author	Shrey Shah
 * @brief	Declares Project 12 timebase and blocking-delay services
 * @version	v1.0
 * @date	26-08-2026
 *
 * @details
 ...
 * This service configures the selected source as one fixed 1 ms interrupt-
 * driven timebase, owns the monotonic software tick and selected strong IRQ
...
/**
 * @brief Project 12 application timing service
