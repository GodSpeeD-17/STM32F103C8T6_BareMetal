 ...
 * @file	app_time.c
 * @author	Shrey Shah
 * @brief	Implements Project 11 timebase and blocking-delay services
 * @version	v1.0
 * @date	26-08-2026
 *
 * @details
...
/** @brief Timer instance selected as the Project 11 application timebase @def APP_TIMEBASE_TIMER_INSTANCE */
