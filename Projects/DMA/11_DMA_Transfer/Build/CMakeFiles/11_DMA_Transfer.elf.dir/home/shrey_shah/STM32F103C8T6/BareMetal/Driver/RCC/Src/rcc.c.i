# 0 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
# 1 "/home/shrey_shah/STM32F103C8T6/Projects/DMA/11_DMA_Transfer/Build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
# 13 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
...
# 22 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Inc/rcc_config.h"
...
# 23 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Inc/rcc_config.h" 2
...
# 14 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c" 2
...
# 35 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
driver_status_t RCC_FlashConfig(const rcc_flash_config_t flash, uint32_t* reg){

 *reg &= (uint32_t)((0x1UL << (4U)) | (0x7UL << (0U)));

 *reg |= (uint32_t)(
  ((flash.prefetch & 0x01) << (4U)) |
  ((flash.latency & 0x07) << (0U))
 );

 return DRIVER_SUCCESS;
}
# 55 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
driver_status_t RCC_PLLConfig(const rcc_pll_config_t pllConfig, uint32_t* reg){

 *reg &= ~(uint32_t)((0xFUL << (18U)) | (0x1UL << (17U)) | (0x1UL << (16U)));

 *reg |= (uint32_t)(
  ((pllConfig.mul_fact & 0x0F) << (18U)) |
  ((pllConfig.src & 0x01) << (16U)) |
  ((pllConfig.src_prescaler & 0x01) << (17U))
 );

 return DRIVER_SUCCESS;
}
# 76 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
driver_status_t RCC_BusConfig(const rcc_bus_prescaler_config_t busPrescalerConfig, uint32_t* reg){

 *reg &= ~(uint32_t)((0x7UL << (11U)) | (0x7UL << (8U)) | (0xFUL << (4U)));

 *reg |= (uint32_t)(
   ((busPrescalerConfig.APB2 & 0x07) << (11U)) |
   ((busPrescalerConfig.APB1 & 0x07) << (8U)) |
   ((busPrescalerConfig.AHB & 0x0F) << (4U))
 );

 return DRIVER_SUCCESS;
}
# 97 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
driver_status_t RCC_ComponentConfig(const rcc_component_prescaler_config_t componentPrescalerConfig, uint32_t* reg){

 *reg &= ~(uint32_t)((0x3UL << (14U)) | (0x1UL << (22U)));

 *reg |= (uint32_t)(
   ((componentPrescalerConfig.USB & 0x01) << (22U)) |
   ((componentPrescalerConfig.ADC & 0x03) << (14U))
 );

 return DRIVER_SUCCESS;
}
# 116 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc.c"
driver_status_t RCC_Config(const rcc_config_t* rccConfig){

 driver_status_t status = DRIVER_FAIL;

 uint32_t reg = ((FLASH_TypeDef *) (0x40022000))->ACR.REG;
 status = RCC_FlashConfig(rccConfig->flash, &reg);
 do { if ((status) != DRIVER_SUCCESS) { return (status); } } while (0);

 ((FLASH_TypeDef *) (0x40022000))->ACR.REG = reg;

 reg = ((RCC_TypeDef *) (0x40018000 + 0x00009000))->CFGR.REG;

 if(rccConfig->system.clk_src != ((system_clock_t) 0x00)){

  if((rccConfig->system.clk_src == ((system_clock_t) 0x02)) && (rccConfig->system.pll.src == ((system_clock_t) 0x00))){
   status = DRIVER_FAIL;
   return status;
  }
 ...
 ((RCC_TypeDef *) (0x40018000 + 0x00009000))->CFGR.REG = reg;

 if(rccConfig->system.clk_src == ((system_clock_t) 0x02)){
...
void RCC_72MHz_FlashDefaultConfig(rcc_flash_config_t* flashConfig){
 ...
 flashConfig->latency = (0x2UL << (0U));

 flashConfig->prefetch = (0x1UL << (4U));
}
...
void RCC_72MHz_PLLDefaultConfig(rcc_pll_config_t* pllConfig){
 ...
 pllConfig->src = ((rcc_pll_src_t) 0x01);

 pllConfig->src_prescaler = ((rcc_pll_src_prescaler_t) 0x00);

 pllConfig->mul_fact = ((rcc_pll_mul_t) 0x07);
}
...
void RCC_72MHz_SystemDefaultConfig(rcc_sys_clk_config_t* sysClkConfig){
 ...
 sysClkConfig->clk_src = ((system_clock_t) 0x02);
...
void RCC_72MHz_BusPrescalerDefaultConfig(rcc_bus_prescaler_config_t* busPrescalerConfig){
 ...
 busPrescalerConfig->AHB = ((rcc_bus_prescaler_t) 0x00);

 busPrescalerConfig->APB1 = ((rcc_bus_prescaler_t) 0x04);

 busPrescalerConfig->APB2 = ((rcc_bus_prescaler_t) 0x00);
}
...
void RCC_72MHz_ComponentPrescalerDefaultConfig(rcc_component_prescaler_config_t* componentPrescalerConfig){
 ...
 componentPrescalerConfig->ADC = ((component_prescaler_t) 0x02);

 componentPrescalerConfig->USB = ((component_prescaler_t) 0x00);
}
