# 0 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/GPIO/Src/gpio_config.c"
# 1 "/home/shrey_shah/STM32F103C8T6/Projects/DMA/11_DMA_Transfer/Build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/GPIO/Src/gpio_config.c"
...
# 3 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/GPIO/Src/gpio_config.c" 2



const GPIO_TypeDef* const __gpioDriverMapping__[7] =
{
 ((GPIO_TypeDef *) (0x40010000 + 0x00000800)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00000C00)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00001000)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00001400)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00001800)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00001C00)),
 ((GPIO_TypeDef *) (0x40010000 + 0x00002000))
};
# 26 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/GPIO/Src/gpio_config.c"
void __GPIO_updateCtrlRegister__(const gpio_pin_t pinMask, const gpio_pin_mode_t gpioMode, gpio_pin_cnf_t gpioCnf, uint32_t* gpioCtrlReg){
 ...
 *gpioCtrlReg |= ((gpioMode & 0x03) << maskPos);
 ...
 if(gpioMode == ((gpio_pin_mode_t) 0x00)){
  if((gpioCnf == ((gpio_pin_cnf_t) 0x03)) || (gpioCnf == ((gpio_pin_cnf_t) 0x02)))
   gpioCnf = 0x02;
 }

 *gpioCtrlReg |= ((gpioCnf & 0x03) << (maskPos + 2));
}
# 51 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/GPIO/Src/gpio_config.c"
void __GPIO_updatePullConfig__(const gpio_pin_t pinMask, gpio_pin_cnf_t gpioCnf, uint32_t* gpioODRReg){

 if(gpioCnf == ((gpio_pin_cnf_t) 0x03)){
  *gpioODRReg |= pinMask;
 }

 else if(gpioCnf == ((gpio_pin_cnf_t) 0x02)){
  *gpioODRReg &= ~(pinMask);
 }
}
