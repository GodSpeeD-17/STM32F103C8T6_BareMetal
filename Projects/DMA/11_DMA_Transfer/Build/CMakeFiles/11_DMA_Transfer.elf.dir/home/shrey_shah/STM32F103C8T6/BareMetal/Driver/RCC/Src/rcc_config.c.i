# 0 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
# 1 "/home/shrey_shah/STM32F103C8T6/Projects/DMA/11_DMA_Transfer/Build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
# 13 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
...
# 14 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c" 2
...
# 28 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
driver_status_t RCC_CoreClockFreq_Update(freq_t* coreClockFrequencyHz){

 system_clock_t coreClockSource = RCC_SysClkSrc_Get();
 if((coreClockSource != ((system_clock_t) 0x01)) && (coreClockSource != ((system_clock_t) 0x00)) && (coreClockSource != ((system_clock_t) 0x02))){
 ...
 switch(coreClockSource){
  ...
  case ((system_clock_t) 0x00):
   *coreClockFrequencyHz = ((freq_t) 8000000);
  break;

  case ((system_clock_t) 0x01):
   *coreClockFrequencyHz = ((freq_t) 8000000);
  break;

  case ((system_clock_t) 0x02):

   *coreClockFrequencyHz = ((freq_t) 8000000);

   if(RCC_PLLClkSrc_Get() == ((rcc_pll_src_t) 0x00)){
    *coreClockFrequencyHz = ((freq_t) 8000000);
   }
...
# 70 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
driver_status_t RCC_AHBClockFreq_Update(freq_t* ahbClockFrequencyHz){
...
# 89 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
driver_status_t RCC_APB1ClockFreq_Update(freq_t* apb1ClockFrequencyHz){
...
# 108 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
driver_status_t RCC_APB2ClockFreq_Update(freq_t* apb2ClockFrequencyHz){
...
# 127 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/RCC/Src/rcc_config.c"
driver_status_t RCC_ClockFreq_Update(rcc_clk_freq_t* clkFreq){
