# 0 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c"
# 1 "/home/shrey_shah/STM32F103C8T6/Projects/DMA/11_DMA_Transfer/Build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c"
# 42 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c"
...
# 7 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Inc/timer_config.h" 2
...
# 9 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Inc/timer_config.h" 2
...
# 43 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c" 2
...
uint16_t TIM_Calc_Prescaler(uint32_t freq_Hz, uint16_t arr_value)
{
 ...
 if (RCC_Get_APB1_Prescaler() != 0x00000000U)
...
static void __TIM__Config_Default__(timer_config_t *TIMx_CONFIG)
{
...
void TIM_10kHz_Load_Default(timer_config_t *TIMx_CONFIG)
{
 ...
 TIMx_CONFIG->clk.auto_reload = ((uint16_t)9999);

 TIMx_CONFIG->clk.prescaler = ((uint16_t)7199);

 TIMx_CONFIG->clk.count = ((uint16_t)0);
...
void TIM_1MHz_Load_Default(timer_config_t *TIMx_CONFIG)
{
 ...
 TIMx_CONFIG->clk.auto_reload = ((uint16_t)999);

 TIMx_CONFIG->clk.prescaler = ((uint16_t)71);
...
void TIM_Channel_CCMRx_Config(tim_channel_t channel, tim_channel_config_t config, uint16_t *ccmr_reg)
{
 uint8_t index = (uint8_t)(((channel & TIMx_CHANNEL_2) || (channel & TIMx_CHANNEL_4)) ? (8U) : (0U));
 *ccmr_reg &= ~(0xFF << index);
...
void TIM_Config(timer_config_t *TIMx_CONFIG)
{
 ...
 TIMx_CONFIG->instance->CR1.REG |= (((TIMx_CONFIG->config.preload_arr & 0x01) << (7U)) |
            ((TIMx_CONFIG->config.mode & 0x03) << (5U)) |
            ((TIMx_CONFIG->config.direction & 0x01) << (4U)) |
            ((TIMx_CONFIG->config.one_pulse & 0x01) << (3U)) |
            ((TIMx_CONFIG->config.update_source & 0x01) << (2U)));
...
# 246 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c"
void TIM_delay_us(TIM_TypeDef *TIMx, uint32_t delayUs)
{
...
# 275 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/Timer/Src/timer.c"
void TIM_delay_ms(TIM_TypeDef *TIMx, uint32_t delayMs)
{
...
void TIM_IRQ_Enable(TIM_TypeDef *TIMx, tim_irq_t IRQ)
{
 ...
 reg = (((uint32_t)TIMx - (uint32_t)((TIM_TypeDef *) (0x40000000 + 0x00000000))) >> 10);
...
void TIM_Reset(TIM_TypeDef *TIMx)
{
 ...
 uint32_t reg = ((RCC_TypeDef *) (0x40018000 + 0x00009000))->APB1RSTR.REG;

 if (TIMx == ((TIM_TypeDef *) (0x40000000 + 0x00000000)))
 {
  reg |= (0x1UL << (0U));
 }
 if (TIMx == ((TIM_TypeDef *) (0x40000000 + 0x00000400)))
 {
  reg |= (0x1UL << (1U));
 }
 if (TIMx == ((TIM_TypeDef *) (0x40000000 + 0x00000800)))
 {
  reg |= (0x1UL << (2U));
 }

 ((RCC_TypeDef *) (0x40018000 + 0x00009000))->APB1RSTR.REG = reg;
...
uint32_t TIM_Get_Frequency(TIM_TypeDef *TIMx)
{
 ...
 if (TIMx != ((Adv_TIM_TypeDef *) (0x40010000 + 0x00002C00)) && TIMx != ((Adv_TIM_TypeDef *) (0x40010000 + 0x00003400)))
 {
