# 0 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
# 1 "/home/shrey_shah/STM32F103C8T6/Projects/DMA/11_DMA_Transfer/Build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
# 11 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
...
# 12 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c" 2



const DMA_Channel_TypeDef* _driverDMAChannelMapping[] =
{
 [((dma_channel_t) 0x00)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[0])),
 [((dma_channel_t) 0x01)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[1])),
 [((dma_channel_t) 0x02)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[2])),
 [((dma_channel_t) 0x03)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[3])),
 [((dma_channel_t) 0x04)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[4])),
 [((dma_channel_t) 0x05)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[5])),
 [((dma_channel_t) 0x06)] = ((DMA_Channel_TypeDef *) (&((DMA_TypeDef *) (0x40018000 + 0x00008000))->CHANNEL[6])),

 [((dma_channel_t) 0x07)] = ((DMA_Channel_TypeDef *)(&((DMA_TypeDef *) ((0x40018000 + 0x00008000) + 0x00000400))->CHANNEL[0])),
 [((dma_channel_t) 0x08)] = ((DMA_Channel_TypeDef *)(&((DMA_TypeDef *) ((0x40018000 + 0x00008000) + 0x00000400))->CHANNEL[1])),
 [((dma_channel_t) 0x09)] = ((DMA_Channel_TypeDef *)(&((DMA_TypeDef *) ((0x40018000 + 0x00008000) + 0x00000400))->CHANNEL[2])),
 [((dma_channel_t) 0x0A)] = ((DMA_Channel_TypeDef *)(&((DMA_TypeDef *) ((0x40018000 + 0x00008000) + 0x00000400))->CHANNEL[3])),
 [((dma_channel_t) 0x0B)] = ((DMA_Channel_TypeDef *)(&((DMA_TypeDef *) ((0x40018000 + 0x00008000) + 0x00000400))->CHANNEL[4]))
};


const irq_t _driverDMAIRQMapping[] =
{
 [((dma_channel_t) 0x00)] = ((irq_t) 11),
 [((dma_channel_t) 0x01)] = ((irq_t) 12),
 [((dma_channel_t) 0x02)] = ((irq_t) 12),
 [((dma_channel_t) 0x03)] = ((irq_t) 14),
 [((dma_channel_t) 0x04)] = ((irq_t) 15),
 [((dma_channel_t) 0x05)] = ((irq_t) 16),
 [((dma_channel_t) 0x06)] = ((irq_t) 17)
...
# 58 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
void _DMA_configEndPoint(const dma_endpoint_t dmaPeripheralConfig, const dma_endpoint_t dmaMemoryConfig, uint32_t* reg)
{
 *reg &= ~(uint32_t) (
  (0x3UL << (10U)) |
 ...
 *reg |= (uint32_t)(
  ((dmaMemoryConfig.size & 0x03) << (10U)) |
  ((dmaPeripheralConfig.size & 0x03) << (8U)) |
  ((dmaMemoryConfig.increment & 0x01) << (7U)) |
  ((dmaPeripheralConfig.increment & 0x01) << (6U))
 );
}
...
void _DMA_configChannelPriority(const dma_channel_priority_t priority, uint32_t* reg)
{
 *reg &= ~(uint32_t)((0x3UL << (12U)));
 *reg |= (uint32_t)((priority & 0x03) << (12U));
}
...
void _DMA_configChannelDirection(const dma_transfer_dir_t direction, uint32_t* reg)
{
 *reg &= ~(uint32_t)((0x1UL << (4U)));
 *reg |= (uint32_t)((direction & 0x01) << (4U));
}
...
void _DMA_configChannelCircularMode(const dma_circular_mode_t circular, uint32_t* reg)
{
 *reg &= ~(uint32_t)((0x1UL << (5U)));
 *reg |= (uint32_t)((circular & 0x01) << (5U));
}
...
void _DMA_configChannelMEM2MEM(const dma_circular_mode_t mem2mem, uint32_t* reg)
{
 *reg &= ~(uint32_t)((0x1UL << (14U)));
 *reg |= (uint32_t)((mem2mem & 0x01) << (14U));
}
...
void _DMA_configTransfer(const dma_channel_t dmaChannel, const dma_transfer_t* const dmaTransfer)
{
 ...
 DMA_Channel_TypeDef* dmaXChannelY = _DMA_getChannel(dmaChannel);
 if(_DMA_getChannelDirection(dmaChannel) == ((dma_transfer_dir_t) 0x00))
 {
...
# 167 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
void _DMA_enableIRQ(const dma_channel_t dmaChannel, dma_irq_t dmaIRQ)
{

 uint32_t reg = __DMA_getChannelCCR(_DMA_getChannel(dmaChannel));
 reg |= (uint32_t) ((dmaIRQ & 0x07) << (1U));
 __DMA_setChannelCCR(_DMA_getChannel(dmaChannel), reg);

 NVIC_IRQEnable(_driverDMAIRQMapping[dmaChannel]);
}
# 185 "/home/shrey_shah/STM32F103C8T6/BareMetal/Driver/DMA/Src/dma_low_level.c"
void _DMA_disableIRQ(const dma_channel_t dmaChannel, dma_irq_t dmaIRQ)
{
