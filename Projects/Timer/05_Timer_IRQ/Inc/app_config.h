...
#if (APP_TIMEBASE_SOURCE == APP_TIME_SOURCE_TIM3)
#error "APP_TIMEBASE_SOURCE=TIM3 conflicts with this project because the Timer IRQ demo exclusively owns TIM3."
#endif /* TIM3 application ownership */
